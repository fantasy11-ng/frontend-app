...
function EditArticleContent() {
  ...
  const handleUpdate = async () => {
    if (!title.trim() || !postData?.post?.id) {
      return;
    }
  ...
  const handleDelete = async () => {
    ...
    await deletePost.mutateAsync(postData.post.id);
    router.push('/cms-k9x2m7p4/dashboard');
  };
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-700 font-semibold">Edit Article</span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                disabled={!title.trim() || updatePost.isPending}
