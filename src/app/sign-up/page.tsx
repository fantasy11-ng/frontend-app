...
export default function SignUpPage() {
  ...
  const passwordRequirements = [
    { label: 'Lowercase characters', met: /[a-z]/.test(password) },
    { label: 'Uppercase characters', met: /[A-Z]/.test(password) },
    { label: 'Numbers', met: /[0-9]/.test(password) },
    { label: '14 characters minimum', met: password.length >= 14 },
    { label: 'Special characters', met: /[!@#$%^&*(),.?":{}|<>]/.test(password) },
  ];
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="text-[#070A11] w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border text-[#070A11] border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="text-[#070A11] w-full px-4 py-3 pr-12 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
          ...
          <div className="flex items-center my-6">
            ...
            <span className="px-4 text-sm text-gray-500">Or sign up using</span>
            <div className="flex-1 border-t border-gray-300"></div>
          </div>
          ...
          <div className="grid gap-3">
            <button
              ...
              className="flex items-center justify-center space-x-2 border border-gray-300 rounded-lg py-3 px-4 hover:bg-gray-50 transition-colors"
            >
...
{/* 
          ...
          <div className="mt-4 text-center">
            <p className="text-gray-600">
              ...
              <Link href="/sign-in" className="text-green-600 hover:text-green-700 font-medium underline">
                Sign in
              </Link>
            </p>
          </div>
