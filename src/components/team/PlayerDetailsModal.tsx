          ...
          <div className="relative flex items-start justify-between">
            <div className="flex-1">
              ...
              <p className="text-green-400 text-sm">
                #{player.jerseyNumber || 'N/A'} {getPositionLabel(player.position)}
              </p>
            </div>
        ...
        <div className="px-6 py-4 border-b border-gray-200">
          <div className="grid grid-cols-5 gap-4">
            <div>
              ...
              <p className="text-sm font-semibold text-gray-900">{formatPrice(player.price)}</p>
            </div>
            <div>
              <p className="text-xs text-gray-500 mb-1">Points</p>
              <p className="text-sm font-semibold text-gray-900">{player.points || 0}</p>
            </div>
            <div>
              <p className="text-xs text-gray-500 mb-1">Goals</p>
              <p className="text-sm font-semibold text-gray-900">{player.goals || 0}</p>
            </div>
            <div>
              <p className="text-xs text-gray-500 mb-1">Assists</p>
              <p className="text-sm font-semibold text-gray-900">{player.assists || 0}</p>
            </div>
            <div>
              <p className="text-xs text-gray-500 mb-1">Cards</p>
              <p className="text-sm font-semibold text-gray-900">{player.cards || 0}</p>
            </div>
          </div>
        </div>
